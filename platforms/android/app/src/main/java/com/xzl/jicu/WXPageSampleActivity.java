...
public class WXPageSampleActivity extends BasePageActivity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // 2019-01-02 注释以下代码，url不是json格式，导致循环异常
//    if (uri == null) {
//      uri = Uri.parse("{}");
//    }
    if (uri != null) {
...
//                @Override
//                public void run() {
//                  Toast.makeText(WXPageSampleActivity.this, "Hot reload", Toast.LENGTH_SHORT).show();
//                  createWeexInstance();
//                  renderPage();
//                }
//              });
...
//                @Override
//                public void run() {
//                  Toast.makeText(WXPageSampleActivity.this, "Render: " + bundleUrl, Toast.LENGTH_SHORT).show();
//                  createWeexInstance();
//                  loadUrl(bundleUrl);
//                }
//              });
    ...
    if (!TextUtils.isEmpty(code)) {
      ...
      if (uri.getQueryParameterNames().contains("bundle")) {
        ...
        try {
          ...
          Intent intent = new Intent(WXPageSampleActivity.this, WXPageSampleActivity.class);
