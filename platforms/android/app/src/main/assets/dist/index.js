...
var _wxcTabBar = __webpack_require__(89);
...
exports.default = {
  ...
  methods: {
    ...
    firstAutoLocation: function firstAutoLocation() {
      var _this9 = this;
        ...
        if (locations && locations.length === 1) {
          locations.forEach(function (element) {
            ...
            (0, _amap.regeo)({ location: amapLocation, extensions: 'all' }).then(function (data) {
              ...
              _this9.city = regeoName;
              console.log('首页自动定位结果', JSON.stringify(cityData));
              (0, _utils3.setStorageVal)('way:city', JSON.stringify(cityData)).then(function (data) {
    ...
    aboutClick: function aboutClick() {
      navigator.push({
        url: (0, _utils3.getEntryUrl)('views/user/about'),
        animated: 'true'
      });
    },
    feedbackClick: function feedbackClick() {
      navigator.push({
        url: (0, _utils3.getEntryUrl)('views/user/feedback'),
        animated: 'true'
      });
    }
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('wxc-tab-bar', {
    ...
    staticClass: ["m_cell", "flex_column_center"]
    ...
    staticClass: ["c_name"]
  }, [_vm._v(_vm._s(_vm.my.nickname))])])])]) : _vm._e(), (_vm.my.userLoginId != 0) ? _c('div', {
    staticClass: ["m_cell_split"]
    ...
    on: {
      "wxcCellClicked": _vm.feedbackClick
    }
  }) : _vm._e(), _c('wxc-cell', {
    attrs: {
      "title": "关于",
    ...
    on: {
      "wxcCellClicked": _vm.aboutClick
    }
  }), (_vm.my.userLoginId == 0) ? _c('div', {
    staticClass: ["m_cell_split"]
  }) : _vm._e(), (_vm.my.userLoginId == 0) ? _c('wxc-cell', {
    attrs: {
      "hasArrow": false,
  ...
  })], 1)]) : _vm._e(), (_vm.my.userLoginId != 0) ? _c('div', {
    staticClass: ["m_cell_split"]
  }) : _vm._e(), (_vm.my.userLoginId != 0) ? _c('wxc-cell', {
    attrs: {
      "hasArrow": false,
