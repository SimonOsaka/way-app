...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/src/views/city/queryForAddress.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3537f8c9"
...
exports.default = {
  components: { WxcSearchbar: _wxcSearchbar2.default, WxcCell: _wxcCell2.default, navbar: _navbar2.default },
  data: function data() {
    return {
      searchList: [],
      keywords: '',
  ...
  beforeCreate: function beforeCreate() {
    ...
    (0, _utils3.titlebar)(this.navbarTitle);
  },
  ...
  methods: {
    wxcIndexlistItemClicked: function wxcIndexlistItemClicked(i) {
      console.log(i);
      var city = this.searchList[i];
      (0, _utils3.postMessage)('user:address:city', JSON.stringify(city));
      navigator.pop({
        animated: 'true'
      });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), (_vm.searchList.length > 0) ? _c('div', _vm._l((_vm.searchList), function(result, i) {
    return _c('wxc-cell', {
      key: i,
      attrs: {
