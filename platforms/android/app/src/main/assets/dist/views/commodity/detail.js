...
var _wxcOverlay = __webpack_require__(22);
...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/src/views/commodity/detail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0a8e900d"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _wxcPopup = __webpack_require__(64);
...
var _commodity = __webpack_require__(120);
...
exports.default = {
  components: { WxcCell: _wxcCell2.default, WxcPopup: _wxcPopup2.default, WxcDialog: _wxcDialog2.default, WxcMask: _wxcMask2.default, navbar: _navbar2.default, WxcButton: _wxcButton2.default, WxcLightbox: _wxcLightbox2.default },
  data: function data() {
    return {
      cellStyle: {
        paddingTop: 0,
  ...
  methods: {
    localUser: function localUser() {
      var _this3 = this;

      (0, _utils3.getStorageVal)('way:user').then(function (data) {
        var user = JSON.parse(data);
        _this3.user.userLoginId = user.userLoginId;
        _this3.user.token = user.userToken;
    ...
    getCommodityData: function getCommodityData() {
      ...
      (0, _commodity.getCommodityDetail)({
        commodityId: this.commodityObj.id,
        userLoginId: this.user.userLoginId === 0 ? undefined : this.user.userLoginId
      }).then(function (data) {
        console.log('success', data);
        if (data.code != 200) {
          _this4.dialogContent = data.msg;
          _this4.dialogShow = true;
        }
        var commodityDetail = data.data;
        _this4.commodityObj.id = commodityDetail.id;
        _this4.shop.hasFollowed = commodityDetail.hasFollowed;
        if (commodityDetail.hasFollowed === 0) {
          _this4.follow.btnText = '已关注';
          _this4.follow.btnType = 'white';
        } else {
          _this4.follow.btnText = '+ 关注';
          _this4.follow.btnType = 'blue';
        }

        _this4.commodityObj.cName = commodityDetail.name;
        // this.commodityObj.cPrice = commodityDetail.price
        _this4.commodityObj.cPosition = commodityDetail.shopAddress;
        if (commodityDetail['imgUrl'] && commodityDetail['imgUrl'] !== '') {
          _this4.commodityObj.cPicUrlList.push({ cPicUrl: commodityDetail.imgUrl });
          _this4.lightBox.imageList.push({ src: commodityDetail.imgUrl });
        }
        if (commodityDetail['imgUrl1'] && commodityDetail['imgUrl1'] !== '') {
          _this4.commodityObj.cPicUrlList.push({ cPicUrl: commodityDetail.imgUrl1 });
          _this4.lightBox.imageList.push({ src: commodityDetail.imgUrl1 });
        }
        if (commodityDetail['imgUrl2'] && commodityDetail['imgUrl2'] !== '') {
          _this4.commodityObj.cPicUrlList.push({ cPicUrl: commodityDetail.imgUrl2 });
          _this4.lightBox.imageList.push({ src: commodityDetail.imgUrl2 });
        }
        if (commodityDetail['imgUrl3'] && commodityDetail['imgUrl3'] !== '') {
          _this4.commodityObj.cPicUrlList.push({ cPicUrl: commodityDetail.imgUrl3 });
          _this4.lightBox.imageList.push({ src: commodityDetail.imgUrl3 });
        }
        if (commodityDetail['imgUrl4'] && commodityDetail['imgUrl4'] !== '') {
          _this4.commodityObj.cPicUrlList.push({ cPicUrl: commodityDetail.imgUrl4 });
          _this4.lightBox.imageList.push({ src: commodityDetail.imgUrl4 });
        }
        _this4.commodityObj.shopId = commodityDetail.shopId;
        _this4.commodityObj.shopName = commodityDetail.shopName;
        _this4.commodityObj.shopLogoUrl = commodityDetail.shopLogoUrl;

        _this4.requestQueryRelationCommodity();
      });
    },
    ...
    requestQueryRelationCommodity: function requestQueryRelationCommodity() {
      var _this5 = this;

      (0, _utils3.getStorageVal)('way:city').then(function (data) {
        console.log('way:city', data);
        var cityObj = JSON.parse(data);
        var clientLng = cityObj.lng;
        var clientLat = cityObj.lat;
        var commodityId = _this5.commodityObj.id;
        (0, _commodity.queryRelationCommodity)({ commodityId: commodityId, clientLng: clientLng, clientlat: clientLat }).then(function (response) {
          if (response.code !== 200) {
            return;
          }
          _this5.relationCommodityList = response.data;
        });
      }, function (err) {});
    },
    relationCommodityCellClicked: function relationCommodityCellClicked(i) {
      var clickedCommodity = this.relationCommodityList[i];
      if (clickedCommodity) {
        console.log('跳转到商品详情页面', clickedCommodity.id);
        (0, _utils3.setStorageVal)('way:commodity:id', clickedCommodity.id);
        navigator.push({
    ...
    btnFollowClicked: function btnFollowClicked() {
      ...
      (0, _utils3.getStorageVal)('way:user').then(function (data) {
        var user = JSON.parse(data);
        _this6.user.userLoginId = user.userLoginId;
        _this6.user.token = user.userToken;

        if (_this6.shop.hasFollowed === 1) {
          _this6.requestFollow();
        } else {
          _this6.requestCancelFollow();
        }
      }, function (error) {
        _this6.user.userLoginId = 0;
        _this6.user.token = '';
        navigator.push({
    ...
    requestFollow: function requestFollow() {
      ...
      (0, _shop.shopFollow)({
        ...
        _this7.shop.hasFollowed = 0;
        _this7.follow.btnText = '已关注';
        _this7.follow.btnType = 'white';
      });
    },
    requestCancelFollow: function requestCancelFollow() {
      ...
      (0, _shop.cancelFollow)({
        ...
        _this8.shop.hasFollowed = 1;
        _this8.follow.btnText = '+ 关注';
        _this8.follow.btnType = 'blue';
      });
    },
    wxcLightboxOverlayClicked: function wxcLightboxOverlayClicked() {
      this.lightBox.show = false;
    },
    commodityImgClicked: function commodityImgClicked(i) {
...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/node_modules/weex-ui/packages/wxc-lightbox/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.getCommodityDetail = getCommodityDetail;
exports.getWeixinShareWebpage = getWeixinShareWebpage;
exports.queryRelationCommodity = queryRelationCommodity;

var _http = __webpack_require__(1);

function getCommodityDetail(params) {
  return (0, _http.http)({
    method: "POST",
...
function queryRelationCommodity(params) {
  return (0, _http.http)({
    method: "POST",
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('navbar', {
    ...
    slot: "title"
  }, [_vm._v(_vm._s(_vm.commodityObj.shopName))]), _c('wxc-button', {
    attrs: {
      "slot": "value",
      "type": _vm.follow.btnType,
      "size": "small",
    ...
    slot: "title"
  }, [_c('text', [_vm._v(_vm._s(_vm.commodityObj.cName))])])])], 1), _c('div', [_c('wxc-cell', {
    ...
    slot: "title"
  }, _vm._l((_vm.commodityObj.cPicUrlList), function(item, index) {
    return _c('image', {
      key: 'pic_list_' + index,
      staticStyle: {
        width: "200px",
      ...
      on: {
        "click": function($event) {
          _vm.commodityImgClicked(index)
        }
      }
    })
  }))])], 1), _c('div', [_c('wxc-cell', {
    attrs: {
      "hasArrow": false,
      "hasBottomBorder": false,
      "cellStyle": _vm.cellStyle
    ...
    staticClass: ["iconfont", "address_icon"]
  }, [_vm._v("")]), _c('text', {
    staticClass: ["address_text"]
  }, [_vm._v(_vm._s(_vm.commodityObj.cPosition))])])])], 1), _c('div', [_c('wxc-cell', {
    attrs: {
      "hasArrow": false,
      "hasTopBorder": true,
  ...
  }, [_vm._v("")])])])])], 1), _c('div', _vm._l((_vm.relationCommodityList), function(relationItem, index) {
    return _c('wxc-cell', {
      key: 'relation' + index,
      attrs: {
        "hasArrow": false,
      ...
      on: {
        "wxcCellClicked": function($event) {
          _vm.relationCommodityCellClicked(index)
        }
      }
    }, [_c('image', {
      staticClass: ["commodity_image"],
      attrs: {
        "slot": "label",
        "resize": "cover",
        "src": relationItem.imgUrl
      },
      slot: "label"
    }), _c('div', {
      attrs: {
      ...
      staticClass: ["c_name"]
    }, [_vm._v(_vm._s(relationItem.name))]), _c('text', {
      staticStyle: {
        fontSize: "24px"
      }
    }, [_vm._v(_vm._s(relationItem.wayShop.shopDistance))])]), _c('div', {
      staticStyle: {
        flexDirection: "row",
        justifyContent: "space-between",
        marginTop: "64px",
    ...
    }, [_vm._v(" " + _vm._s(relationItem.wayShop.shopName))])])])])
  }))]), _c('wxc-popup', {
    attrs: {
      "height": "160",
      "show": _vm.isAutoShow,
  ...
  }, [_vm._v("微信朋友圈")])])])]), _c('wxc-lightbox', {
    ref: "wxc-lightbox",
    attrs: {
      "height": _vm.lightBox.height,
      "show": _vm.lightBox.show,
      "index": _vm.lightBox.index,
      "imageList": _vm.lightBox.imageList
    },
    on: {
