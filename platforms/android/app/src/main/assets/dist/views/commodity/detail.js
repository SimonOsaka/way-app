...
var _wxcPopup = __webpack_require__(63);
...
var _commodity = __webpack_require__(115);
...
exports.default = {
  ...
  methods: {
    ...
    requestQueryRelationCommodity: function requestQueryRelationCommodity() {
      ...
      var commodityId = this.commodityObj.id;
      (0, _commodity.queryRelationCommodity)({ commodityId: commodityId }).then(function (response) {
        if (response.code !== 200) {
          return;
        }
        _this3.relationCommodityList = response.data;
      });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('navbar', {
    ...
    slot: "title"
  }, [_vm._v(_vm._s(_vm.commodityObj.shopName))])])], 1), _c('div', _vm._l((_vm.relationCommodityList), function(relationItem, index) {
    return _c('wxc-cell', {
      key: 'relation' + index,
      attrs: {
        "hasArrow": false,
      ...
      staticClass: ["c_name"]
    }, [_vm._v(_vm._s(relationItem.name))])])])
  }))]), _c('wxc-popup', {
    attrs: {
      "height": "160",
      "show": _vm.isAutoShow,
