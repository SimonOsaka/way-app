...
Component.options.__file = "/Volumes/code/way/way-app-ios/src/views/shop/detail.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-dc75c858", Component.options)
  } else {
    hotAPI.reload("data-v-dc75c858", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("ad033314", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dc75c858\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./detail.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dc75c858\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./detail.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.iconfont[data-v-dc75c858] {\n  font-family: iconfont;\n  font-size: 0.42667rem;\n  font-style: normal;\n}\n.scroller[data-v-dc75c858] {\n  width: 10rem;\n}\n.image[data-v-dc75c858] {\n  width: 10rem;\n  height: 6.66667rem;\n}\n.image_shop[data-v-dc75c858] {\n  width: 3.41333rem;\n  height: 3.41333rem;\n}\n.text_shop[data-v-dc75c858] {\n  font-size: 0.85333rem;\n  font-weight: bold;\n}\n", ""]);
  ...
  created: function created() {
    ...
    (0, _utils3.receiveMessage)('m:way:login', function (data) {
      ...
      if (data.status === 0 && data.val === 'success') {
        _this2.initShopDetail();
      }
    });
  },

  methods: {
    initShopDetail: function initShopDetail() {
      var _this = this;
    ...
    requestShopDetail: function requestShopDetail() {
      var _this3 = this;

      (0, _shop.getShopDetail)({
        shopId: this.shop.id,
        ...
        _this3.shop.id = shopDetail.id;
        _this3.shop.shopName = shopDetail.shopName;
        _this3.shop.shopAddress = shopDetail.shopAddress;
        _this3.shop.shopTel = shopDetail.shopTel;
        _this3.shop.shopBusinessTimeAll = shopDetail.shopBusinessTime1 + ' ' + shopDetail.shopBusinessTime2;
        _this3.shop.shopLogoUrl = shopDetail.shopLogoUrl;
        _this3.shop.hasFollowed = shopDetail.follow.hasFollowed;
        if (shopDetail.follow.hasFollowed === 0) {
          _this3.follow.btnText = '已关注';
        } else {
          _this3.follow.btnText = '关注';
        }
      }, function (error) {
        console.error('failure', error);
      });
    },
    btnFollowClicked: function btnFollowClicked() {
      var _this4 = this;

      (0, _utils3.getStorageVal)('way:user').then(function (data) {
        var user = JSON.parse(data);
        _this4.user.userLoginId = user.userLoginId;
        _this4.user.token = user.userToken;

        if (_this4.shop.hasFollowed === 1) {
          _this4.requestFollow();
        } else {
          _this4.requestCancelFollow();
        }
      }, function (error) {
        _this4.user.userLoginId = 0;
        _this4.user.token = '';
        navigator.push({
          url: (0, _utils3.getEntryUrl)('views/user/login', { tabIndex: 0 }),
          animated: 'true'
        });
      });
    },
    requestFollow: function requestFollow() {
      ...
      (0, _shop.shopFollow)({
        ...
        _this5.shop.hasFollowed = 0;
        _this5.follow.btnText = '已关注';
      });
    },
    requestCancelFollow: function requestCancelFollow() {
      var _this6 = this;
      ...
      (0, _shop.cancelFollow)({
        ...
        _this6.shop.hasFollowed = 1;
        _this6.follow.btnText = '关注';
      });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "image_shop weex-el weex-image",
    attrs: {
      "src": _vm.shop.shopLogoUrl,
      "data-img-src": _vm.shop.shopLogoUrl,
      "weex-type": "image"
    }
  }), _vm._v(" "), _c('p', {
    staticClass: "text_shop weex-el weex-text",
    attrs: {
      "weex-type": "text"
    }
  }, [_vm._v(_vm._s(_vm.shop.shopName))])]), _vm._v(" "), _c('div', {
    staticClass: " weex-ct weex-div",
    staticStyle: {
    ...
    attrs: {
      "type": "blue",
      "size": "small",
      "btnStyle": "{borderColor: red, backgroundColor: '#fff'}",
      "textStyle": "{color: red}",
      "text": _vm.follow.btnText,
      "data-evt-wxcButtonClicked": ""
    },
    on: {
      "wxcButtonClicked": _vm.btnFollowClicked
    }
  })], 1), _vm._v(" "), _c('div', {
    staticClass: " weex-ct weex-div",
    staticStyle: {
    ...
    attrs: {
      "label": "营业时间：",
      "title": _vm.shop.shopBusinessTimeAll,
      "has-arrow": false,
      "has-bottom-border": true
    }
  })], 1)])], 1)
