...
Component.options.__file = "E:\\workspace-on_the_way\\ios.jicu.vip\\src\\views\\user\\login.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-516c73fe", Component.options)
  } else {
    hotAPI.reload("data-v-516c73fe", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("2557f67f", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-516c73fe\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./login.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-516c73fe\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./login.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    nativeOn: {
      "input": function($event) {
        $event.stopPropagation();
        return _vm.userTelOninput($event)
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: " weex-ct weex-div",
    ...
    nativeOn: {
      "input": function($event) {
        $event.stopPropagation();
        return _vm.userValidCodeOninput($event)
      }
    }
    ...
    nativeOn: {
      "input": function($event) {
        $event.stopPropagation();
        return _vm.userNameOninput($event)
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: " weex-ct weex-div",
    ...
    nativeOn: {
      "input": function($event) {
        $event.stopPropagation();
        return _vm.userPasswordOninput($event)
      }
    }
  })])]), _vm._v(" "), (_vm.loginTab == 0) ? _c('div', {
    staticClass: " weex-ct weex-div",
    staticStyle: {
      "-webkit-box-align": "center",
      "-webkit-align-items": "center",
    ...
    staticClass: "user_agreement weex-el weex-text",
    attrs: {
      "weex-type": "text"
    }
  }, [_vm._v(" 首次登录即代表注册，并且同意 ")]), _vm._v(" "), _c('p', {
    staticClass: "user_agreement link weex-el weex-text",
    attrs: {
      "weex-type": "text",
      "data-evt-click": ""
    },
  ...
  }, [_vm._v("《用户服务协议》 ")])])]), _vm._v(" "), _c('wxc-dialog', {
    attrs: {
      "title": "提示",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-516c73fe", module.exports)
  }
}
