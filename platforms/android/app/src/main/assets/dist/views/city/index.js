...
exports.regeo = regeo;
exports.coordinateConvert = coordinateConvert;
 ...
 */
function coordinateConvert(params) {
  return (0, _http.http)({
    method: 'POST',
    url: '/amap/convert',
    headers: {},
...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/src/views/city/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-30a6a9c8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _wxcTag = __webpack_require__(58);
...
var _wxcSearchbar = __webpack_require__(36);
...
var _amap = __webpack_require__(42);
...
exports.default = {
  components: { WxcSearchbar: _wxcSearchbar2.default, WxcCell: _wxcCell2.default, category: _category2.default, navbar: _navbar2.default, WxcTag: _wxcTag2.default },
  data: function data() {
    return {
      searchList: [],
      userAddressList: [],
  ...
  created: function created() {
    ...
    (0, _utils3.receiveMessage)('user:address:city:part', function (data) {
      if (data.status === 0) {
        _this2.requestUserAddressList();
      }
    });
  ...
  methods: {
    userAddressListItemClicked: function userAddressListItemClicked(i) {
      var rs = this.userAddressList[i];
      this.city.name = rs.addressName;
      var location = [rs.addressLongitude, rs.addressLatitude].join(',');
      this.regeo(location);
    },
    requestUserAddressList: function requestUserAddressList() {
      var _this3 = this;
      ...
      (0, _utils3.getStorageVal)('way:user').then(function (data) {
        ...
        (0, _user.queryUserAddressList)(params, headers).then(function (data) {
          ...
          if (_this3.userAddressList.length > 0) {
            _this3.userAddressList.splice(0, _this3.userAddressList.length);
          }
          ...
          resultList.forEach(function (item) {
            var userAddress = {
              ...
              addressTag: item.tag,
              addressTagName: _this3.tagMap[item.tag],
              addressLongitude: item.longitude,
              addressLatitude: item.latitude
            };
            _this3.userAddressList.push(userAddress);
          });
        });
      });
    },
    ...
    wxcSearchbarInputOnInput: function wxcSearchbarInputOnInput(e) {
      ...
      this.inputTimeout = setTimeout(function () {
        _this4.inputTipsFetch();
      }, 500);
    },
    inputTipsFetch: function inputTipsFetch() {
      var _this5 = this;

      (0, _amap.inputtips)({ keywords: this.keywords }).then(function (data) {
        if (data.code != 200) {
          return;
        }
        _this5.searchList.splice(0, _this5.searchList.length);
        var inputTipsList = data.data;
        inputTipsList.forEach(function (tip) {
          _this5.searchList.push({
    ...
    regeo: function regeo(location) {
      ...
      (0, _amap.regeo)({ location: location }).then(function (data) {
        if (data.code != 200) {
          return;
        }
        ...
        _this6.city.lng = loc[0];
        _this6.city.lat = loc[1];
        _this6.city.cityCode = cityCode;

        _this6.requestUpdateUserProfileAddress();

        _this6.storeLocalWayCity();
      }, function (error) {
        console.error('failure', error);
      });
    },
    storeLocalWayCity: function storeLocalWayCity() {
      (0, _utils3.setStorageVal)('way:city', JSON.stringify(this.city)).then(function (data) {
    ...
    autoLocation: function autoLocation(gpsLocation) {
      var _this7 = this;

      (0, _amap.coordinateConvert)({ locationList: [gpsLocation] }).then(function (data) {
        var locations = data.data;
        if (locations && locations.length === 1) {
          locations.forEach(function (element) {
            var amapLocation = [element.longitude, ',', element.latitude].join('');
            (0, _amap.regeo)({ location: amapLocation, extensions: 'all' }).then(function (data) {
              if (data.code !== 200) {
                return;
              }
              var regeoData = data.data;
              var regeoName = regeoData.neighborhoodName;
              var regeoLocation = regeoData.neighborhoodLocation;
              var regeoCityCode = regeoData.cityCode;
              _this7.city.name = regeoName;
              _this7.city.lng = regeoLocation.split(',')[0];
              _this7.city.lat = regeoLocation.split(',')[1];
              _this7.city.cityCode = regeoCityCode;
              _this7.currentAddress = regeoName;
              console.log('自动定位结果', JSON.stringify(_this7.city));
            });
          });
        }
      });
    },
    autoLocationCellClicked: function autoLocationCellClicked() {
      this.requestUpdateUserProfileAddress();
      this.storeLocalWayCity();
    },
    reAutoLocation: function reAutoLocation() {
      ...
      if (isIOS) {
        ...
        var lng = dictionary.getDict('longitude');
        var lat = dictionary.getDict('latitude');
    ...
    requestUpdateUserProfileAddress: function requestUpdateUserProfileAddress() {
      var _this8 = this;
      ...
      (0, _utils3.getStorageVal)('way:user').then(function (data) {
        ...
        (0, _user.updateUserProfileAddress)({
          userLoginId: user.userLoginId,
          addressName: _this8.city.name,
          addressLongitude: _this8.city.lng,
          addressLatitude: _this8.city.lat
        }, {
          token: user.userToken
        });
      }, function (error) {});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('navbar', {
    ...
    attrs: {
      ...
      "alwaysShowCancel": _vm.alwaysShowCancel,
      "returnKeyType": _vm.returnKeyType
    },
    on: {
      "wxcSearchbarInputReturned": _vm.wxcSearchbarInputOnInput
    }
  }), (_vm.currentAddress != '') ? _c('div', [_c('category', {
    attrs: {
      "title": "定位地址"
    }
  }), _c('wxc-cell', {
    ...
    on: {
      "click": _vm.autoLocationCellClicked
    },
    slot: "title"
  }, [_c('text', {
  ...
  }, [_vm._v(" " + _vm._s(_vm.currentAddress))])]), _c('div', {
    attrs: {
      "slot": "value"
    },
    on: {
      "click": _vm.reAutoLocation
    },
    slot: "value"
  }, [_c('text', {
    staticClass: ["iconfont"]
  }, [_vm._v(" 重新定位")])])])], 1) : _vm._e(), _c('div', [_c('category', {
    attrs: {
      "title": "我的地址"
    }
  }, [_c('text', {
    ...
    slot: "right"
  }, [_vm._v("操作 ")])]), _vm._l((_vm.userAddressList), function(item, i) {
    return _c('wxc-cell', {
      key: i,
      attrs: {
        "hasArrow": false,
      ...
      on: {
        "wxcCellClicked": function($event) {
          _vm.userAddressListItemClicked(i)
        }
      }
    }, [_c('div', {
      staticStyle: {
  ...
  })], 2), (_vm.searchList.length > 0) ? _c('div', [_c('category', {
    attrs: {
      "title": "搜索地址"
    }
  }), _vm._l((_vm.searchList), function(result, i) {
    return _c('wxc-cell', {
      key: i,
      attrs: {
