...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/src/views/discount/create.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ad24e540"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _wxcMask = __webpack_require__(26);

var _wxcMask2 = _interopRequireDefault(_wxcMask);

var _wxcLoading = __webpack_require__(80);
...
var _wxcGridSelect = __webpack_require__(86);
...
exports.default = {
  ...
  beforeCreate: function beforeCreate() {
    ...
    (0, _utils.setPageTitle)('发布优惠');

    (0, _utils.getStorageVal)('way:city').then(function (data) {
      var city = JSON.parse(data);
      _this2.cityCode = city.cityCode;
    }, function (e) {
      navigator.push({
        url: (0, _utils.getEntryUrl)('views/city/index'),
        animated: 'true'
      });
    });
  },
  ...
  methods: {
    ...
    createDiscountClicked: function createDiscountClicked(e) {
      ...
      if ((0, _utils.isEmpty)(this.commodityName) || (0, _utils.isEmpty)(this.commodityPrice) || (0, _utils.isEmpty)(this.shopPosition) || (0, _utils.isEmpty)(this.shopAddress) || (0, _utils.isEmpty)(this.commodityCate) || this.expireDays < 1) {
        modal.toast({
          message: '请填全信息',
          duration: 2
        });
      ...
      if ((0, _utils.isEmpty)(this.clientLng) || (0, _utils.isEmpty)(this.clientLat)) {
        modal.toast({
          message: '请输入并选择商家位置',
          duration: 2
        });
      ...
      var _this = this;
      (0, _utils.getStorageVal)('way:user').then(function (data) {
        _this4.isShow = true;
        ...
        (0, _http.http)({
          ...
          var lateTimeout = setTimeout(function () {
            ...
            (0, _utils.postMessage)('way:tab:selectedIndex', 1);
            navigator.push({
              url: (0, _utils.getEntryUrl)('index'),
              animated: 'true'
            });
          }, 2000);
        }, function (error) {
...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/node_modules/weex-ui/packages/wxc-loading/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/node_modules/weex-ui/packages/wxc-grid-select/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
var _option = __webpack_require__(90);
...
__vue_options__.__file = "/Volumes/code/way/way-app-ios/node_modules/weex-ui/packages/wxc-grid-select/option.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('scroller', {
    ...
    on: {
      "input": _vm.commodityNameOnchange
    }
  }), _c('category', {
    attrs: {
      "title": "商品价格（元）"
    ...
    on: {
      "input": _vm.commodityPriceOnchange
    }
  }), _c('category', {
    attrs: {
      "title": "商家位置"
    ...
    on: {
      "click": _vm.openShopPositionMask
    }
  }, [_vm._v("")])]), _c('input', {
    staticClass: ["input"],
    attrs: {
    ...
    on: {
      "input": _vm.shopPositionOnchange
    }
  }), _c('div', _vm._l((_vm.inputTipsList), function(tip, i) {
    return _c('div', {
      key: i,
      staticStyle: {
    ...
    }, [_vm._v(_vm._s(tip.name))]), _c('text', {
      staticStyle: {
        color: "#cccccc"
      }
