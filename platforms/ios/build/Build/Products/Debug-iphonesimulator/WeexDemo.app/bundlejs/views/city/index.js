...
exports.default = {
  components: { WxcSearchbar: _wxcSearchbar2.default, WxcCell: _wxcCell2.default, category: _category2.default },
  data: function data() {
    return {
      searchList: [],
      keywords: '',
  ...
  methods: {
    ...
    regeo: function regeo(location) {
      ...
      (0, _http.http)({
        ...
        (0, _utils.postMessage)('way:city', JSON.stringify(_this.city));
        navigator.push({
