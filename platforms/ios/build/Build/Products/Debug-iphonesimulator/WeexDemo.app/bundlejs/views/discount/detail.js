...
var _wxcNoticebar = __webpack_require__(99);
...
var _wxcCountdown = __webpack_require__(105);
...
exports.default = {
  ...
  created: function created() {
    ...
    this.discountObj.id = (0, _utils.getUrlKey)('discountId');
    ...
    (0, _utils.setStorageVal)('way:discount:id', this.discountObj.id);
  ...
  methods: {
    ...
    discountDetailHttp: function discountDetailHttp() {
      ...
      (0, _http.http)({
        ...
        (0, _utils.setPageTitle)(_this.discountObj.cName);
        (0, _utils.setOgImage)(_this.discountObj.commodityImageUrl);
      }, function (error) {
        console.error('failure', error);
      });
    },
    increaseReal: function increaseReal(operate, realType) {
      ...
      (0, _utils.getStorageVal)('way:user').then(function (data) {
        ...
        navigator.push({
          url: (0, _utils.getEntryUrl)('views/user/login'),
          animated: true
        });
      });
    },
    ...
    clickStaticMap: function clickStaticMap() {
      ...
      (0, _utils.getStorageVal)('way:city').then(function (data) {
        ...
        window.location.href = '//m.amap.com/navi/?start=' + start + '&dest=' + dest + '&destName=' + destName + '&naviBy=walk&key=e318d250a2b4d53d864f7d712cc069da';
      }, function (err) {
        window.location.href = '//m.amap.com/navi/?dest=' + dest + '&destName=' + destName + '&key=e318d250a2b4d53d864f7d712cc069da';
      });
    },
