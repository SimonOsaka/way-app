...
var _wxcTabBar = __webpack_require__(63);
...
exports.default = {
  ...
  created: function created() {
    ...
    // );
    // alert("外面");
    (0, _utils3.receiveMessage)('way:tab:selectedIndex').then(function (data) {
      console.log('接收消息selectedIndex', data);
      // alert("里面");
      if (data.val) {
        // alert("tab1");
        var index = data.val;
        _this2.switchTabContent(index);
        _this2.$refs['wxc-tab-bar'].setPage(index);
      } else {
        // alert("tab0");
        _this2.initMainTab();
      }
  ...
  methods: {
    ...
    loadDiscountTabContent: function loadDiscountTabContent() {
      ...
      if (!this.discountTabContentInitTime || this.discountTabContentInitTime < new Date().getTime()) {
        this.discountTabContentInitTime = new Date(new Date().getTime() + 3600 * 1000).getTime();
    ...
    fetchDiscount: function fetchDiscount(event) {
      var _this = this;
      (0, _utils3.getStorageVal)('way:city').then(function (data) {
    ...
    logoutClicked: function logoutClicked(e) {
      ...
      (0, _http.http)({
        ...
        (0, _utils3.postMessage)('way:tab:selectedIndex', 2);
    ...
    discountCellClicked: function discountCellClicked(i) {
      ...
      (0, _utils3.postMessage)('way:discount:id', discount.discountId);
      navigator.push({
    ...
    // },
    discountOnRefresh: function discountOnRefresh() {
    ...
    onpullingdown: function onpullingdown(event) {
      ...
      console.log('pulling down', event.pullingDistance, event.dy, event.viewHeight);
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('text', [_vm._v(_vm._s(_vm.refreshText))]), _c('loading-indicator')]), _vm._l((_vm.discountList), function(discountObj, i) {
    return _c('div', {
      key: i,
      ref: 'cell' + i,
      refInFor: true,
