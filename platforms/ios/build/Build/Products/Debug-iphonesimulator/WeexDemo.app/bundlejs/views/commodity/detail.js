...
var _wxcPopup = __webpack_require__(43);
...
exports.default = {
  components: { WxcCell: _wxcCell2.default, WxcPopup: _wxcPopup2.default, WxcDialog: _wxcDialog2.default, WxcMask: _wxcMask2.default },
  data: function data() {
    return {
  ...
  created: function created() {
    var _this = this;
    _this.commodityObj.id = (0, _utils.getUrlKey)('cid');
    ...
    (0, _http.http)({
      ...
      (0, _utils.setPageTitle)(commodityDetail.name);
      (0, _utils.setOgImage)(_this.commodityObj.cPicUrl);
    }, function (error) {
      console.error('failure', error);
    });
  },
  ...
  methods: {
    ...
    shopCellClicked: function shopCellClicked() {
      (0, _utils.postMessage)('way:shop:id', this.commodityObj.shopId);
      navigator.push({
        url: (0, _utils.getEntryUrl)('views/shop/detail'),
        animated: 'true'
      });
    },
    weixinMaskSetHidden: function weixinMaskSetHidden() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('scroller', {
    ...
    slot: "title"
  }, [_vm._v(_vm._s(_vm.commodityObj.shopName))])])], 1)]), _c('wxc-popup', {
    attrs: {
      "height": "160",
      "show": _vm.isAutoShow,
      "pos": "bottom"
    ...
    on: {
      "wxcMaskSetHidden": _vm.weixinMaskSetHidden
    }
  }, [_c('div', {
    staticStyle: {
